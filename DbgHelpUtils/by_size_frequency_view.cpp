        ...
        for(auto const& bucket : sorted_range(buckets | std::views::transform([this, &buckets](std::pair<uint64_t, bucket_entries> const& data)
            {
                ...
                return process_heaps_statistic_bucket_view{size_units::base_16::bytes{key}
