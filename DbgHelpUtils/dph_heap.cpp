...
namespace dlg_help_utils::heap
{
    ...
    std::generator<dph_heap> dph_heap::dph_heaps(cache_manager& cache, process::process_environment_block const& peb)
    {
    ...
    std::generator<dph_entry> dph_heap::busy_entries() const
    {
    ...
    std::generator<dph_entry> dph_heap::free_entries() const
    {
    ...
    std::generator<dph_entry> dph_heap::virtual_ranges() const
    {
    ...
    std::generator<dph_entry> dph_heap::walk_list(uint64_t const head, uint64_t const tail, dph_entry::is_virtual_allocation const is_virtual_allocation) const
    {
