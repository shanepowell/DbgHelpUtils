...
namespace dlg_help_utils::heap
{
    ...
    public:
        ...
        [[nodiscard]] static generator<dph_heap> dph_heaps(cache_manager& cache, process::process_environment_block const& peb);

        [[nodiscard]] generator<dph_entry> busy_entries() const;
        [[nodiscard]] generator<dph_entry> free_entries() const;
        [[nodiscard]] generator<dph_entry> virtual_ranges() const;
    ...
    private:
        ...
        [[nodiscard]] generator<dph_entry> walk_list(uint64_t head, uint64_t tail, dph_entry::is_virtual_allocation is_virtual_allocation) const;
