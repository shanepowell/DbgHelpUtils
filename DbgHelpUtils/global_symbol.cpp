...
{
    global_symbol::global_symbol(stream_stack_dump::mini_dump_memory_walker const& walker, dbg_help::symbol_type_info symbol_info)
    : walker_{&walker}
    , symbol_info_{std::move(symbol_info)}
    {
    }

    mini_dump_memory_stream global_symbol::stream() const
    {
