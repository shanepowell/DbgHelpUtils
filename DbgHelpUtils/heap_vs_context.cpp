...
namespace dlg_help_utils::heap
{
    ...
    dlg_help_utils::generator<heap_vs_subsegment> heap_vs_context::subsegments() const
    {
    ...
    dlg_help_utils::generator<heap_vs_entry> heap_vs_context::free_entries() const
    {
