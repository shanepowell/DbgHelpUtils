...
namespace dlg_help_utils::memory_info_utils
{
    ...
    std::vector<std::wstring> memory_protection_options_to_strings(uint32_t memory_protection_options);
    ...
    std::vector<std::wstring> system_memory_info_flags_to_strings(uint16_t flags);
}
