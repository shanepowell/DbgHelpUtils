...
namespace dlg_help_utils::heap
{
    ...
    generator<heap_segment> nt_heap::segments() const
    {
    ...
    generator<heap_ucr_descriptor> nt_heap::uncommitted_ranges() const
    {
    ...
    generator<heap_virtual_block> nt_heap::heap_virtual_blocks() const
    {
    ...
    generator<heap_entry> nt_heap::free_entries() const
    {
