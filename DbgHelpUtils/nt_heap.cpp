...
namespace dlg_help_utils::heap
{
    ...
    {
        return stream_utils::get_field_value<uint32_t>(*this, common_symbol_names::heap_segment_signature_field_symbol_name);
    }
    ...
    {
        return stream_utils::get_field_value<uint32_t>(*this, common_symbol_names::heap_total_segments_field_symbol_name);
    }
    ...
    {
        return stream_utils::get_field_value<uint16_t>(*this, common_symbol_names::heap_allocator_back_trace_index_field_symbol_name);
    }

    uint8_t nt_heap::front_end_heap_type() const
    {
        return stream_utils::get_field_value<uint8_t>(*this, common_symbol_names::heap_front_end_heap_type_field_symbol_name);
    }

    std::experimental::generator<heap_segment> nt_heap::segments() const
    {
        for (ntdll_utilities::list_entry_walker const list_walker{walker(), stream_utils::get_field_address(*this, common_symbol_names::heap_segment_list_field_symbol_name), heap_segment::symbol_name, common_symbol_names::heap_segment_list_entry_field_symbol_name}; 
    ...
    {
        for (ntdll_utilities::list_entry_walker const list_walker{walker(), stream_utils::get_field_address(*this, common_symbol_names::heap_ucr_list_field_symbol_name), heap_ucr_descriptor::symbol_name, common_symbol_names::heap_ucr_descriptor_list_entry_field_symbol_name}; 
            auto const entry_address : list_walker.entries())
        {
    ...
    {
        for (ntdll_utilities::list_entry_walker const list_walker{walker(), stream_utils::get_field_address(*this, common_symbol_names::heap_virtual_allocated_blocks_field_symbol_name), heap_virtual_block::symbol_name, common_symbol_names::heap_virtual_alloc_entry_entry_field_symbol_name}; 
            auto const entry_address : list_walker.entries())
        {
    ...
    {
        for (ntdll_utilities::list_entry_walker const list_walker{walker(), stream_utils::get_field_address(*this, common_symbol_names::heap_free_lists_field_symbol_name), common_symbol_names::heap_free_entry_structure_symbol_name, common_symbol_names::heap_free_entry_free_list_field_symbol_name}; 
            auto const entry_address : list_walker.entries())
        {
    ...
    std::optional<lfh_heap> nt_heap::lfh_heap() const
    {
        ...
        auto const address = stream_utils::get_field_pointer(*this, common_symbol_names::heap_front_end_heap_field_symbol_name);
        if(address == 0)
        {
            return std::nullopt;
        }
