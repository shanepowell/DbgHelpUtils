...
namespace dlg_help_utils::heap::allocation_graph
{
    ...
    {
    public:
        process_heap_entry_symbol_address_reference(uint64_t address, dbg_help::symbol_type_info symbol_type, uint32_t thread_id, std::wstring thread_name);
        process_heap_entry_symbol_address_reference(uint64_t address, dbg_help::symbol_type_info symbol_type);
