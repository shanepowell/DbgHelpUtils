...
namespace dlg_help_utils::heap
{
    ...
    dlg_help_utils::generator<process_heap_entry> process_heaps::entries() const
    {
    ...
    dlg_help_utils::generator<process_heap_entry> process_heaps::free_entries() const
    {
    ...
    dlg_help_utils::generator<process_heap_entry> process_heaps::all_free_entries() const
    {
        crt_heap const crt_heap{ cache(), peb() };
    ...
    dlg_help_utils::generator<process_heap_entry> process_heaps::filter_entries() const
    {
    ...
    dlg_help_utils::generator<process_heap_entry> process_heaps::filter_free_entries() const
    {
        if(base_diff_filter_ != nullptr)
        {
