...
namespace dlg_help_utils::heap
{
    ...
    public:
        ...
        [[nodiscard]] std::generator<process_heap_entry> entries() const;
        [[nodiscard]] std::generator<process_heap_entry> free_entries() const;
    ...
    private:
        ...
        [[nodiscard]] std::generator<process_heap_entry> all_free_entries() const;

        [[nodiscard]] std::generator<process_heap_entry> filter_entries() const;
        [[nodiscard]] std::generator<process_heap_entry> filter_free_entries() const;
