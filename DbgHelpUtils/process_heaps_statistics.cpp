...
{
    process_heaps_statistics::process_heaps_statistics(process_heaps const& process, statistic_views::system_module_list const& system_module_list)
    : process_{process}
    ...
    {
        return process_heaps_statistic_view{process_heaps_statistic_view::view_type::by_size_frequency, helper_, process_, allocated_entries_, free_entries_};
    }

    process_heaps_statistic_view process_heaps_statistics::view_by_size_ranges_frequency() const
    {
        return process_heaps_statistic_view{process_heaps_statistic_view::view_type::by_size_ranges_frequency, helper_, process_, allocated_entries_, free_entries_};
    }

    process_heaps_statistic_view process_heaps_statistics::view_by_stacktrace_frequency() const
    {
        return process_heaps_statistic_view{process_heaps_statistic_view::view_type::by_stacktrace_frequency, helper_, process_, allocated_entries_, free_entries_};
    }

    process_heaps_statistic_view process_heaps_statistics::view_by_application_callsite_frequency() const
    {
        return process_heaps_statistic_view{process_heaps_statistic_view::view_type::by_application_callsite_frequency, helper_, process_, allocated_entries_, free_entries_};
    }
