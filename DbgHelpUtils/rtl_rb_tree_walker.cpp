...
namespace dlg_help_utils::ntdll_utilities
{
    ...
    , rtl_balanced_node_entry_offset_{stream_utils::get_field_offset_from_type(stream_utils::get_type(walker_, entry_symbol_name), entry_symbol_name, entry_field_name)}
    {
    }
