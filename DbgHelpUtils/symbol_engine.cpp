...
namespace dlg_help_utils::dbg_help
{
    ...
    dlg_help_utils::generator<std::wstring> symbol_engine::loaded_modules() const
    {
    ...
    dlg_help_utils::generator<symbol_address_info> symbol_engine::stack_walk(stream_thread_context const& thread_context) const
    {
        thread_context_type type;
        DWORD machine_type;
        STACKFRAME_EX frame{};
