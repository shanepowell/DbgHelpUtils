...
namespace
{
    ...
    std::unordered_map<windows_version, std::wstring_view> const version_strings =
    {
        ...
        {windows_version{10, 0, 17763, VER_NT_SERVER, 0, 0}, L"Windows Server 2019 1909"sv},
        {windows_version{10, 0, 17623, VER_NT_SERVER, 0, 0}, L"Windows Server 2019 20H2"sv},
        {windows_version{10, 0, 17764, VER_NT_SERVER, 0, 0}, L"Windows Server vNext"sv},
        {windows_version{10, 0, 19042, VER_NT_SERVER, 0, 0}, L"Windows Server 2019"sv},
        {windows_version{10, 0, 17134, VER_NT_SERVER, 0, 0}, L"Windows Server 2019 (Semi-Annual Channel) (Datacenter, Standard)"sv},

        {windows_version{10, 0, 16299, VER_NT_SERVER, 0, 0}, L"Windows Server 2016 Fall Creators Update"sv},
        {windows_version{10, 0, 16299, VER_NT_SERVER, 0, 0}, L"Windows Server 2016 Fall Creators Update"sv},
        ...
        {windows_version{10, 0, 19042, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 20H2"sv},
        {windows_version{10, 0, 19041, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 2004"sv},
        {windows_version{10, 0, 18363, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 1909"sv},
        {windows_version{10, 0, 18362, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 1903"sv},
        {windows_version{10, 0, 17763, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 October 2018"sv},
        {windows_version{10, 0, 17134, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 April 2018"sv},
        {windows_version{10, 0, 16299, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 Fall Creators Update"sv},
        {windows_version{10, 0, 15063, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 Creators Update"sv},
        {windows_version{10, 0, 14393, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 Aniversary Update"sv},
        {windows_version{10, 0, 10586, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 November Update"sv},
        {windows_version{10, 0, 10240, VER_NT_WORKSTATION, 0, 0}, L"Windows 10 Gold"sv},
