...
namespace
{
    ...
    std::unordered_map<uint64_t, std::wstring> g_other_processor_features =
    {
        {1ULL << PF_FLOATING_POINT_PRECISION_ERRATA, L"PF_FLOATING_POINT_PRECISION_ERRATA"s},
        {1ULL << PF_FLOATING_POINT_EMULATED, L"PF_FLOATING_POINT_EMULATED"s},
        {1ULL << PF_COMPARE_EXCHANGE_DOUBLE, L"PF_COMPARE_EXCHANGE_DOUBLE"s},
        {1ULL << PF_MMX_INSTRUCTIONS_AVAILABLE, L"PF_MMX_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_PPC_MOVEMEM_64BIT_OK, L"PF_PPC_MOVEMEM_64BIT_OK"s},
        {1ULL << PF_ALPHA_BYTE_INSTRUCTIONS, L"PF_ALPHA_BYTE_INSTRUCTIONS"s},
        {1ULL << PF_XMMI_INSTRUCTIONS_AVAILABLE, L"PF_XMMI_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_3DNOW_INSTRUCTIONS_AVAILABLE, L"PF_3DNOW_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_RDTSC_INSTRUCTION_AVAILABLE, L"PF_RDTSC_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_PAE_ENABLED, L"PF_PAE_ENABLED"s},
        {1ULL << PF_XMMI64_INSTRUCTIONS_AVAILABLE, L"PF_XMMI64_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_SSE_DAZ_MODE_AVAILABLE, L"PF_SSE_DAZ_MODE_AVAILABLE"s},
        {1ULL << PF_NX_ENABLED, L"PF_NX_ENABLED"s},
        {1ULL << PF_SSE3_INSTRUCTIONS_AVAILABLE, L"PF_SSE3_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_COMPARE_EXCHANGE128, L"PF_COMPARE_EXCHANGE128"s},
        {1ULL << PF_COMPARE64_EXCHANGE128, L"PF_COMPARE64_EXCHANGE128"s},
        {1ULL << PF_CHANNELS_ENABLED, L"PF_CHANNELS_ENABLED"s},
        {1ULL << PF_XSAVE_ENABLED, L"PF_XSAVE_ENABLED"s},
        {1ULL << PF_ARM_VFP_32_REGISTERS_AVAILABLE, L"PF_ARM_VFP_32_REGISTERS_AVAILABLE"s},
        {1ULL << PF_ARM_NEON_INSTRUCTIONS_AVAILABLE, L"PF_ARM_NEON_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_SECOND_LEVEL_ADDRESS_TRANSLATION, L"PF_SECOND_LEVEL_ADDRESS_TRANSLATION"s},
        {1ULL << PF_VIRT_FIRMWARE_ENABLED, L"PF_VIRT_FIRMWARE_ENABLED"s},
        {1ULL << PF_RDWRFSGSBASE_AVAILABLE, L"PF_RDWRFSGSBASE_AVAILABLE"s},
        {1ULL << PF_FASTFAIL_AVAILABLE, L"PF_FASTFAIL_AVAILABLE"s},
        {1ULL << PF_ARM_DIVIDE_INSTRUCTION_AVAILABLE, L"PF_ARM_DIVIDE_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_ARM_64BIT_LOADSTORE_ATOMIC, L"PF_ARM_64BIT_LOADSTORE_ATOMIC"s},
        {1ULL << PF_ARM_EXTERNAL_CACHE_AVAILABLE, L"PF_ARM_EXTERNAL_CACHE_AVAILABLE"s},
        {1ULL << PF_ARM_FMAC_INSTRUCTIONS_AVAILABLE, L"PF_ARM_FMAC_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_RDRAND_INSTRUCTION_AVAILABLE, L"PF_RDRAND_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_ARM_V8_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V8_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_ARM_V8_CRYPTO_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V8_CRYPTO_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_ARM_V8_CRC32_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V8_CRC32_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_RDTSCP_INSTRUCTION_AVAILABLE, L"PF_RDTSCP_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_RDPID_INSTRUCTION_AVAILABLE, L"PF_RDPID_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_MONITORX_INSTRUCTION_AVAILABLE, L"PF_MONITORX_INSTRUCTION_AVAILABLE"s},
        {1ULL << PF_SSSE3_INSTRUCTIONS_AVAILABLE, L"PF_SSSE3_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_SSE4_1_INSTRUCTIONS_AVAILABLE, L"PF_SSE4_1_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_SSE4_2_INSTRUCTIONS_AVAILABLE, L"PF_SSE4_2_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_AVX_INSTRUCTIONS_AVAILABLE, L"PF_AVX_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_AVX2_INSTRUCTIONS_AVAILABLE, L"PF_AVX2_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_AVX512F_INSTRUCTIONS_AVAILABLE, L"PF_AVX512F_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_ERMS_AVAILABLE, L"PF_ERMS_AVAILABLE"s},
        {1ULL << PF_ARM_V82_DP_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V82_DP_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE"s},
        {1ULL << PF_ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE, L"PF_ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE"s},
    };
}
