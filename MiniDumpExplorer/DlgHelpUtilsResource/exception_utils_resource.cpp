...
namespace dlg_help_utils::exception_utils::resources
{
    std::unordered_map<uint32_t, std::wstring> const& get_exception_code_descriptions()
    {
        ...
        {0x0000011C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/ATTEMPTED_WRITE_TO_CM_PROTECTED_STORAGE").ValueAsString()}},
        {0x0000011D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/EVENT_TRACING_FATAL_ERROR").ValueAsString()}},
        {0x0000011E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/TOO_MANY_RECURSIVE_FAULTS").ValueAsString()}},
        {0x0000011F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_DRIVER_HANDLE").ValueAsString()}},
        {0x00000120, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BITLOCKER_FATAL_ERROR").ValueAsString()}},
        {0x00000121, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DRIVER_VIOLATION").ValueAsString()}},
        {0x00000122, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WHEA_INTERNAL_ERROR").ValueAsString()}},
        {0x00000123, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CRYPTO_SELF_TEST_FAILURE").ValueAsString()}},
        {0x00000124, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WHEA_UNCORRECTABLE_ERROR").ValueAsString()}},
        {0x00000125, std::wstring{rm.MainResourceMap().GetValue(L"Resource/NMR_INVALID_STATE").ValueAsString()}},
        {0x00000126, std::wstring{rm.MainResourceMap().GetValue(L"Resource/NETIO_INVALID_POOL_CALLER").ValueAsString()}},
        {0x00000127, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PAGE_NOT_ZERO").ValueAsString()}},
        {0x00000128, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_RETURNED_WITH_BAD_IO_PRIORITY").ValueAsString()}},
        {0x00000129, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_RETURNED_WITH_BAD_PAGING_IO_PRIORITY").ValueAsString()}},
        {0x0000012A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/MUI_NO_VALID_SYSTEM_LANGUAGE").ValueAsString()}},
        {0x0000012B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/FAULTY_HARDWARE_CORRUPTED_PAGE").ValueAsString()}},
        {0x0000012C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/EXFAT_FILE_SYSTEM").ValueAsString()}},
        {0x0000012D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VOLSNAP_OVERLAPPED_TABLE_ACCESS").ValueAsString()}},
        {0x0000012E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_MDL_RANGE").ValueAsString()}},
        {0x0000012F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VHD_BOOT_INITIALIZATION_FAILED").ValueAsString()}},
        {0x00000130, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DYNAMIC_ADD_PROCESSOR_MISMATCH").ValueAsString()}},
        {0x00000131, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_EXTENDED_PROCESSOR_STATE").ValueAsString()}},
        {0x00000132, std::wstring{rm.MainResourceMap().GetValue(L"Resource/RESOURCE_OWNER_POINTER_INVALID").ValueAsString()}},
        {0x00000133, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DPC_WATCHDOG_VIOLATION").ValueAsString()}},
        {0x00000134, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DRIVE_EXTENDER").ValueAsString()}},
        {0x00000135, std::wstring{rm.MainResourceMap().GetValue(L"Resource/REGISTRY_FILTER_DRIVER_EXCEPTION").ValueAsString()}},
        {0x00000136, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VHD_BOOT_HOST_VOLUME_NOT_ENOUGH_SPACE").ValueAsString()}},
        {0x00000137, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_HANDLE_MANAGER").ValueAsString()}},
        {0x00000138, std::wstring{rm.MainResourceMap().GetValue(L"Resource/GPIO_CONTROLLER_DRIVER_ERROR").ValueAsString()}},
        {0x00000139, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_SECURITY_CHECK_FAILURE").ValueAsString()}},
        {0x0000013A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_MODE_HEAP_CORRUPTION").ValueAsString()}},
        {0x0000013B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PASSIVE_INTERRUPT_ERROR").ValueAsString()}},
        {0x0000013C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_IO_BOOST_STATE").ValueAsString()}},
        {0x0000013D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CRITICAL_INITIALIZATION_FAILURE").ValueAsString()}},
        {0x00000140, std::wstring{rm.MainResourceMap().GetValue(L"Resource/STORAGE_DEVICE_ABNORMALITY_DETECTED").ValueAsString()}},
        {0x00000141, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_ENGINE_TIMEOUT_DETECTED").ValueAsString()}},
        {0x00000142, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_TDR_APPLICATION_BLOCKED").ValueAsString()}},
        {0x00000143, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PROCESSOR_DRIVER_INTERNAL").ValueAsString()}},
        {0x00000144, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BUGCODE_USB3_DRIVER").ValueAsString()}},
        {0x00000145, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SECURE_BOOT_VIOLATION").ValueAsString()}},
        {0x00000147, std::wstring{rm.MainResourceMap().GetValue(L"Resource/ABNORMAL_RESET_DETECTED").ValueAsString()}},
        {0x00000149, std::wstring{rm.MainResourceMap().GetValue(L"Resource/REFS_FILE_SYSTEM").ValueAsString()}},
        {0x0000014A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_WMI_INTERNAL").ValueAsString()}},
        {0x0000014B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SOC_SUBSYSTEM_FAILURE").ValueAsString()}},
        {0x0000014C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/FATAL_ABNORMAL_RESET_ERROR").ValueAsString()}},
        {0x0000014D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/EXCEPTION_SCOPE_INVALID").ValueAsString()}},
        {0x0000014E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SOC_CRITICAL_DEVICE_REMOVED").ValueAsString()}},
        {0x0000014F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PDC_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x00000150, std::wstring{rm.MainResourceMap().GetValue(L"Resource/TCPIP_AOAC_NIC_ACTIVE_REFERENCE_LEAK").ValueAsString()}},
        {0x00000151, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UNSUPPORTED_INSTRUCTION_MODE").ValueAsString()}},
        {0x00000152, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_PUSH_LOCK_FLAGS").ValueAsString()}},
        {0x00000153, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_LOCK_ENTRY_LEAKED_ON_THREAD_TERMINATION").ValueAsString()}},
        {0x00000154, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UNEXPECTED_STORE_EXCEPTION").ValueAsString()}},
        {0x00000155, std::wstring{rm.MainResourceMap().GetValue(L"Resource/OS_DATA_TAMPERING").ValueAsString()}},
        {0x00000156, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WINSOCK_DETECTED_HUNG_CLOSESOCKET_LIVEDUMP").ValueAsString()}},
        {0x00000157, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_THREAD_PRIORITY_FLOOR_VIOLATION").ValueAsString()}},
        {0x00000158, std::wstring{rm.MainResourceMap().GetValue(L"Resource/ILLEGAL_IOMMU_PAGE_FAULT").ValueAsString()}},
        {0x00000159, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HAL_ILLEGAL_IOMMU_PAGE_FAULT").ValueAsString()}},
        {0x0000015A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SDBUS_INTERNAL_ERROR").ValueAsString()}},
        {0x0000015B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_RETURNED_WITH_SYSTEM_PAGE_PRIORITY_ACTIVE").ValueAsString()}},
        {0x0000015C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PDC_WATCHDOG_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x0000015D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SOC_SUBSYSTEM_FAILURE_LIVEDUMP").ValueAsString()}},
        {0x0000015E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BUGCODE_NDIS_DRIVER_LIVE_DUMP").ValueAsString()}},
        {0x0000015F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CONNECTED_STANDBY_WATCHDOG_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000160, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_ATOMIC_CHECK_FAILURE").ValueAsString()}},
        {0x00000161, std::wstring{rm.MainResourceMap().GetValue(L"Resource/LIVE_SYSTEM_DUMP").ValueAsString()}},
        {0x00000162, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_AUTO_BOOST_INVALID_LOCK_RELEASE").ValueAsString()}},
        {0x00000163, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_TEST_CONDITION").ValueAsString()}},
        {0x00000164, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_CRITICAL_FAILURE").ValueAsString()}},
        {0x00000165, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_STATUS_IO_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000166, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_RESOURCE_CALL_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000167, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_SNAPSHOT_DEVICE_INFO_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000168, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_STATE_TRANSITION_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000169, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_VOLUME_ARRIVAL_LIVEDUMP").ValueAsString()}},
        {0x0000016A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_VOLUME_REMOVAL_LIVEDUMP").ValueAsString()}},
        {0x0000016B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_CLUSTER_WATCHDOG_LIVEDUMP").ValueAsString()}},
        {0x0000016C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_RUNDOWN_PROTECTION_FLAGS").ValueAsString()}},
        {0x0000016D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_SLOT_ALLOCATOR_FLAGS").ValueAsString()}},
        {0x0000016E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/ERESOURCE_INVALID_RELEASE").ValueAsString()}},
        {0x0000016F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_STATE_TRANSITION_INTERVAL_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x00000170, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CRYPTO_LIBRARY_INTERNAL_ERROR").ValueAsString()}},
        {0x00000171, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSV_CLUSSVC_DISCONNECT_WATCHDOG").ValueAsString()}},
        {0x00000173, std::wstring{rm.MainResourceMap().GetValue(L"Resource/COREMSGCALL_INTERNAL_ERROR").ValueAsString()}},
        {0x00000174, std::wstring{rm.MainResourceMap().GetValue(L"Resource/COREMSG_INTERNAL_ERROR").ValueAsString()}},
        {0x00000175, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PREVIOUS_FATAL_ABNORMAL_RESET_ERROR").ValueAsString()}},
        {0x00000178, std::wstring{rm.MainResourceMap().GetValue(L"Resource/ELAM_DRIVER_DETECTED_FATAL_ERROR").ValueAsString()}},
        {0x00000179, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CLUSPORT_STATUS_IO_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x0000017B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PROFILER_CONFIGURATION_ILLEGAL").ValueAsString()}},
        {0x0000017C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PDC_LOCK_WATCHDOG_LIVEDUMP").ValueAsString()}},
        {0x0000017D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PDC_UNEXPECTED_REVOCATION_LIVEDUMP").ValueAsString()}},
        {0x0000017E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/MICROCODE_REVISION_MISMATCH").ValueAsString()}},
        {0x00000187, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_DWMINIT_TIMEOUT_FALLBACK_BDD").ValueAsString()}},
        {0x00000188, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_CSVFS_LIVEDUMP").ValueAsString()}},
        {0x00000189, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BAD_OBJECT_HEADER").ValueAsString()}},
        {0x0000018B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SECURE_KERNEL_ERROR").ValueAsString()}},
        {0x0000018C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HYPERGUARD_VIOLATION").ValueAsString()}},
        {0x0000018D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SECURE_FAULT_UNHANDLED").ValueAsString()}},
        {0x0000018E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_PARTITION_REFERENCE_VIOLATION").ValueAsString()}},
        {0x00000190, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_CRITICAL_FAILURE_LIVEDUMP").ValueAsString()}},
        {0x00000191, std::wstring{rm.MainResourceMap().GetValue(L"Resource/PF_DETECTED_CORRUPTION").ValueAsString()}},
        {0x00000192, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_AUTO_BOOST_LOCK_ACQUISITION_WITH_RAISED_IRQL").ValueAsString()}},
        {0x00000193, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_DXGKRNL_LIVEDUMP").ValueAsString()}},
        {0x00000195, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SMB_SERVER_LIVEDUMP").ValueAsString()}},
        {0x00000196, std::wstring{rm.MainResourceMap().GetValue(L"Resource/LOADER_ROLLBACK_DETECTED").ValueAsString()}},
        {0x00000197, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_SECURITY_FAILURE").ValueAsString()}},
        {0x00000198, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UFX_LIVEDUMP").ValueAsString()}},
        {0x00000199, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_STORAGE_SLOT_IN_USE").ValueAsString()}},
        {0x0000019A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_RETURNED_WHILE_ATTACHED_TO_SILO").ValueAsString()}},
        {0x0000019B, std::wstring{rm.MainResourceMap().GetValue(L"Resource/TTM_FATAL_ERROR").ValueAsString()}},
        {0x0000019C, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_POWER_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x0000019D, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CLUSTER_SVHDX_LIVEDUMP").ValueAsString()}},
        {0x000001A0, std::wstring{rm.MainResourceMap().GetValue(L"Resource/TTM_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x000001A1, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_CALLOUT_WATCHDOG_LIVEDUMP").ValueAsString()}},
        {0x000001A2, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WIN32K_CALLOUT_WATCHDOG_BUGCHECK").ValueAsString()}},
        {0x000001A3, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CALL_HAS_NOT_RETURNED_WATCHDOG_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x000001A4, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DRIPS_SW_HW_DIVERGENCE_LIVEDUMP").ValueAsString()}},
        {0x000001A5, std::wstring{rm.MainResourceMap().GetValue(L"Resource/USB_DRIPS_BLOCKER_SURPRISE_REMOVAL_LIVEDUMP").ValueAsString()}},
        {0x000001A6, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BLUETOOTH_ERROR_RECOVERY_LIVEDUMP").ValueAsString()}},
        {0x000001A7, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SMB_REDIRECTOR_LIVEDUMP").ValueAsString()}},
        {0x000001A8, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_DXGKRNL_BLACK_SCREEN_LIVEDUMP").ValueAsString()}},
        {0x000001B0, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_MINIPORT_FAILED_LIVEDUMP").ValueAsString()}},
        {0x000001B8, std::wstring{rm.MainResourceMap().GetValue(L"Resource/VIDEO_MINIPORT_BLACK_SCREEN_LIVEDUMP").ValueAsString()}},
        {0x000001C4, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DRIVER_VERIFIER_DETECTED_VIOLATION_LIVEDUMP").ValueAsString()}},
        {0x000001C5, std::wstring{rm.MainResourceMap().GetValue(L"Resource/IO_THREADPOOL_DEADLOCK_LIVEDUMP").ValueAsString()}},
        {0x000001C6, std::wstring{rm.MainResourceMap().GetValue(L"Resource/FAST_ERESOURCE_PRECONDITION_VIOLATION").ValueAsString()}},
        {0x000001C7, std::wstring{rm.MainResourceMap().GetValue(L"Resource/STORE_DATA_STRUCTURE_CORRUPTION").ValueAsString()}},
        {0x000001C8, std::wstring{rm.MainResourceMap().GetValue(L"Resource/MANUALLY_INITIATED_POWER_BUTTON_HOLD").ValueAsString()}},
        {0x000001C9, std::wstring{rm.MainResourceMap().GetValue(L"Resource/USER_MODE_HEALTH_MONITOR_LIVEDUMP").ValueAsString()}},
        {0x000001CA, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SYNTHETIC_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x000001CB, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_SILO_DETACH").ValueAsString()}},
        {0x000001CC, std::wstring{rm.MainResourceMap().GetValue(L"Resource/EXRESOURCE_TIMEOUT_LIVEDUMP").ValueAsString()}},
        {0x000001CD, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_CALLBACK_STACK_ADDRESS").ValueAsString()}},
        {0x000001CE, std::wstring{rm.MainResourceMap().GetValue(L"Resource/INVALID_KERNEL_STACK_ADDRESS").ValueAsString()}},
        {0x000001CF, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HARDWARE_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x000001D0, std::wstring{rm.MainResourceMap().GetValue(L"Resource/CPI_FIRMWARE_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x000001D1, std::wstring{rm.MainResourceMap().GetValue(L"Resource/TELEMETRY_ASSERTS_LIVEDUMP").ValueAsString()}},
        {0x000001D2, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_INVALID_STATE").ValueAsString()}},
        {0x000001D3, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WFP_INVALID_OPERATION").ValueAsString()}},
        {0x000001D4, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UCMUCSI_LIVEDUMP").ValueAsString()}},
        {0x000001D5, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DRIVER_PNP_WATCHDOG").ValueAsString()}},
        {0x000001D6, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WORKER_THREAD_RETURNED_WITH_NON_DEFAULT_WORKLOAD_CLASS").ValueAsString()}},
        {0x000001D7, std::wstring{rm.MainResourceMap().GetValue(L"Resource/EFS_FATAL_ERROR").ValueAsString()}},
        {0x000001D8, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UCMUCSI_FAILURE").ValueAsString()}},
        {0x000001D9, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HAL_IOMMU_INTERNAL_ERROR").ValueAsString()}},
        {0x000001DA, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HAL_BLOCKED_PROCESSOR_INTERNAL_ERROR").ValueAsString()}},
        {0x000001DB, std::wstring{rm.MainResourceMap().GetValue(L"Resource/IPI_WATCHDOG_TIMEOUT").ValueAsString()}},
        {0x000001DC, std::wstring{rm.MainResourceMap().GetValue(L"Resource/DMA_COMMON_BUFFER_VECTOR_ERROR").ValueAsString()}},
        {0x00000356, std::wstring{rm.MainResourceMap().GetValue(L"Resource/XBOX_ERACTRL_CS_TIMEOUT").ValueAsString()}},
        {0x00000BFE, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BC_BLUETOOTH_VERIFIER_FAULT").ValueAsString()}},
        {0x00000BFF, std::wstring{rm.MainResourceMap().GetValue(L"Resource/BC_BTHMINI_VERIFIER_FAULT").ValueAsString()}},
        {0x00020001, std::wstring{rm.MainResourceMap().GetValue(L"Resource/HYPERVISOR_ERROR").ValueAsString()}},
        {0x1000007E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/SYSTEM_THREAD_EXCEPTION_NOT_HANDLED_M").ValueAsString()}},
        {0x1000007F, std::wstring{rm.MainResourceMap().GetValue(L"Resource/UNEXPECTED_KERNEL_MODE_TRAP_M").ValueAsString()}},
        {0x1000008E, std::wstring{rm.MainResourceMap().GetValue(L"Resource/KERNEL_MODE_EXCEPTION_NOT_HANDLED_M").ValueAsString()}},
        {0x100000EA, std::wstring{rm.MainResourceMap().GetValue(L"Resource/THREAD_STUCK_IN_DEVICE_DRIVER_M").ValueAsString()}},
        {0x4000008A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/THREAD_TERMINATE_HELD_MUTEX").ValueAsString()}},
        {0xC0000218, std::wstring{rm.MainResourceMap().GetValue(L"Resource/STATUS_CANNOT_LOAD_REGISTRY_FILE").ValueAsString()}},
        {0xC000021A, std::wstring{rm.MainResourceMap().GetValue(L"Resource/WINLOGON_FATAL_ERROR").ValueAsString()}},
        {0xC0000221, std::wstring{rm.MainResourceMap().GetValue(L"Resource/STATUS_IMAGE_CHECKSUM_MISMATCH").ValueAsString()}},
        {0xDEADDEAD, std::wstring{rm.MainResourceMap().GetValue(L"Resource/MANUALLY_INITIATED_CRASH1").ValueAsString()}},
    ...
    {
        static auto instance1{Utility::GetResourceValue(L"Resources/ContinuableException"sv)};
        static auto instance2{Utility::GetResourceValue(L"Resources/NonContinuableException"sv)};
        return exception_continuable ? instance1 : instance2;
    }

    std::wstring_view get_exception_unwinding(bool const exception_unwinding)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionUnwinding"sv)};
        return exception_unwinding ? instance : L""sv;
    }

    std::wstring_view get_exception_exit_unwind(bool const exception_exit_unwind)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionExitUnwind"sv)};
        return exception_exit_unwind ? instance : L""sv;
    }

    std::wstring_view get_exception_stack_invalid(bool const exception_stack_invalid)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionStackInvalid"sv)};
        return exception_stack_invalid ? instance : L""sv;
    }

    std::wstring_view get_exception_nesting_level(bool const exception_nesting_level)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionNestingLevel"sv)};
        return exception_nesting_level ? instance : L""sv;
    }

    std::wstring_view get_exception_target_unwind(bool const exception_target_unwind)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionTargetUnwind"sv)};
        return exception_target_unwind ? instance : L""sv;
    }

    std::wstring_view get_exception_collided_unwind(bool const exception_collided_unwind)
    {
        static auto instance{Utility::GetResourceValue(L"Resources/ExceptionCollidedUnwind"sv)};
        return exception_collided_unwind ? instance : L""sv;
    }
}
