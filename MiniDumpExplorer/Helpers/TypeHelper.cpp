...
#include "WinrtDepenencyPropertiesReflectionMap.h"
        ...
        dlg_help_utils::generator<std::wstring_view> SplitPropertyPath(std::wstring_view const& propertyPath)
        {
    ...
    dlg_help_utils::generator<winrt::Microsoft::UI::Xaml::DependencyProperty> GetDependencyProperties(winrt::guid const& id)  // NOLINT(misc-use-internal-linkage)
    {
    ...
    dlg_help_utils::generator<winrt::Microsoft::UI::Xaml::DependencyProperty> GetDependencyProperties(winrt::Windows::Foundation::IInspectable const& object)  // NOLINT(misc-use-internal-linkage)
    {
        if(!object)
        {
            co_return;
