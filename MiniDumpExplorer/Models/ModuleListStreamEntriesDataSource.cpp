...
namespace winrt::MiniDumpExplorer::implementation
{
    ...
    fire_and_forget ModuleListStreamEntriesDataSource::LoadMiniDumpModuleStream(dlg_help_utils::module_list_stream module_list, dlg_help_utils::time_utils::locale_timezone_info dump_file_timezone_info)
    {
        auto index = module_list.index();
        co_await Utility::run(__FUNCTION__, [this, module_list = std::move(module_list), dump_file_timezone_info]() -> Windows::Foundation::IAsyncAction
            {
