...
#include "ThreadNamesStreamEntriesDataSource.g.h"
...
namespace winrt::MiniDumpExplorer::implementation
{
    ...
    struct ThreadNameListStreamEntry;

    struct ThreadNamesStreamEntriesDataSource : ThreadNamesStreamEntriesDataSourceT<ThreadNamesStreamEntriesDataSource>
    {
        ThreadNamesStreamEntriesDataSource();
        ...
        fire_and_forget LoadMiniDumpThreadStream(dlg_help_utils::thread_names_list_stream thread_list);
    ...
    private:
        ...
        Windows::Foundation::Collections::IObservableVector<MiniDumpExplorer::ThreadNameListStreamEntry> entries_{winrt::single_threaded_observable_vector<MiniDumpExplorer::ThreadNameListStreamEntry>()};
...
{
    struct ThreadNamesStreamEntriesDataSource : ThreadNamesStreamEntriesDataSourceT<ThreadNamesStreamEntriesDataSource, implementation::ThreadNamesStreamEntriesDataSource>
    {
    };
}
