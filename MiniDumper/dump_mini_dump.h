...
bool process_dump_file(std::wostream& log, std::wstring const& file_name, std::wstring const& base_diff_file_name, dump_file_options const& options);
...
void process_user_mode_dump(std::wostream& log, dlg_help_utils::mini_dump const& dump_file, std::unique_ptr<dlg_help_utils::mini_dump> const& base_diff_dump, dump_file_options const& options);
