...
void dump_mini_dump_heap(
    ...
    , dlg_help_utils::i_value_type_formatter const& formatter);
...
namespace detail
{
    ...
    void print_process_entry(
        std::wostream& log
        , dlg_help_utils::heap::process_heap_entry const& entry
        , dlg_help_utils::process::process_environment_block const& peb
        , dlg_help_utils::i_value_type_formatter const& formatter
        , dump_file_options const& options
        , size_t indent);
    ...
    void print_nt_heap(
        ...
        , dlg_help_utils::i_value_type_formatter const& formatter
        , dump_file_options const& options
        , dlg_help_utils::heap::nt_heap const& nt_heap
        , dlg_help_utils::process::process_environment_block const& peb);
    ...
    void print_segment_heap(
        ...
        , dlg_help_utils::heap::segment_heap const& segment_heap
        , dump_file_options const& options
        , size_t indent);

    void print_segment_heap_line(
        std::wostream& log
        , std::wstring_view const& process_heap_marker
        , dlg_help_utils::heap::segment_heap const& segment_heap);
    ...
    void print_debug_page_heap(
        std::wostream& log
        , dlg_help_utils::i_value_type_formatter const& formatter
        , dlg_help_utils::heap::dph_heap const& heap
        , dump_file_options const& options
        , size_t indent);
}
